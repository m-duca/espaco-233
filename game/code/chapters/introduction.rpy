label introduction:
    # Cenas: TERRA FUTURISTA (bg intro_0), PRÉDIO DA LAZER (bg intro_1), CASA DA LOREN (bg intro_2), NAVE ESTACIONADA (bg intro_3)
    ...
    l "Eu me inscrevi no programa da Lazer e vou pra outro planeta começar uma nova vida!"
