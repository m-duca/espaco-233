label introduction:
    ...
    l "Relaxa, a Lazer vai te mandar um dinheiro por conta da minha falta, ajuda sua família com isso. Agora eu vou indo, tchau maninha."

    scene black with fade

    "No dia da viagem Loren está totalmente preparada, sem remorso algum ela entra na estação de lançamento, tudo já está quase pronto para a decolagem. Nisso ela é recebida por um dos trabalhadores da Lazer."
    ...
    l "Infelizmente mãe, quando eu acordar você já vai estar em outro lugar olhando por mim, mas foi muito bom te ver um último dia aqui na Terra."
    ...
    "Nos últimos segundos conscientes, Loren apenas escuta a voz de sua mãe a chamar."
    ...
    "Chegando na sala, esta completamente sozinha, ela se senta feliz pensando novamente estar adiantada e comemora levemente por sua \"conquista\"."

    "Ao se sentar a apresentação começa automaticamente, ela estranha pois achava que mais pessoas deveriam chegar antes de sua viagem começar. Ela levanta a mão e faz uma pergunta a inteligência artificial."

    l "Com licença, não eram pra ter mais pessoas aqui antes de começarem as explicações?"
